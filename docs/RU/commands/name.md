...
|-----------------------|------------------------------|  
| **Псевдонимы**        | `name`, `nick`, `nickname`, `никнейм`, `ник`, `имя` |  
| **Аргументы**         | `[user ID]` |  
...
| **Дата создания**     | 25/10/2024 (ДД/ММ/ГГГГ)      |  
...
```
ItzKITЬ: _name 22484632 
(Replying to @ItzKITЬ: _name 22484632) butterBror: 👤 @22484632: forsen 
```